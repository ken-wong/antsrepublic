...
ActiveRecord::Schema.define(version: 20160913004058) do
  ...
  create_table "ant_points", force: :cascade do |t|
    t.integer  "total_amounts",  limit: 4
    t.integer  "total_projects", limit: 4
    t.integer  "total_ants",     limit: 4
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
    t.text     "ants_text",      limit: 65535
  end
